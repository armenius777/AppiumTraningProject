...
public class SearchPage extends MainPageObject {
    ...
    public void searchWord(String word) {
        ...
        WebElement searchField =
                waitForElementPresented(Locators.SEARCH_FIELD_ID, 5, "Search field is missing");
        searchField.sendKeys(word);
        waitForElementPresented(Locators.SEARCH_RESULTS_AREA_ID, 5, "Search result is empty");
    }
    ...
    public void backToHome() {
        WebElement backToHome = waitForElementPresented(Locators.BACK_TO_HOME_BUTTON_XPATH, 10,
